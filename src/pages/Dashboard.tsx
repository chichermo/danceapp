  ...
  const recentActivity = [
    {
      id: 1,
      type: 'student',
      message: 'New student registration: Emma Van der Berg',
      time: '2 hours ago',
      avatar: 'EV',
      color: '#FF6B9D',
    },
    {
      id: 2,
      type: 'class',
      message: 'Class completed: Contemporary Adults',
      time: '4 hours ago',
      avatar: 'CA',
      color: '#45B7D1',
    },
    {
      id: 3,
      type: 'choreography',
      message: 'New choreography uploaded: "Modern Flow"',
      time: '6 hours ago',
      avatar: 'MF',
      color: '#6C5CE7',
    },
    {
      id: 4,
      type: 'achievement',
      message: 'Student achievement: First place in Belgian Dance Competition',
      time: '1 day ago',
      avatar: '🏆',
      color: '#FFD93D',
    },
