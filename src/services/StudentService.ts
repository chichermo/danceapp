  ...
  importAllBelgiumStudents(): void {
    ...
    private generateAllBelgiumStudents(): Student[] {
      ...
      const csvData = [
        ...
        { name: 'Van Der Straeten Jules', city: 'Knokke-Heist', group: 'MINI\'S  - Geboortejaar 2021/2020', birthDate: '2020-03-15', phone: '470000080', email: 'jules.vanderstraeten@example.com', regNumber: '20031523881' },
        { name: 'Van Dijck Lola', city: 'Moerkerke', group: 'MINI\'S  - Geboortejaar 2021/2020', birthDate: '2021-01-28', phone: '470000081', email: 'lola.vandijck@example.com', regNumber: '21012823882' },
        { name: 'Van Eyck Felix', city: 'Knokke-Heist', group: 'MINI\'S  - Geboortejaar 2021/2020', birthDate: '2020-11-07', phone: '470000082', email: 'felix.vaneyck@example.com', regNumber: '20110723883' },
        { name: 'Van Gompel Nina', city: 'Westkapelle', group: 'MINI\'S  - Geboortejaar 2021/2020', birthDate: '2021-05-12', phone: '470000083', email: 'nina.vangompel@example.com', regNumber: '21051223884' },
        ...
        { name: 'Van Hove Sarah', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-10-22', phone: '470000086', email: 'sarah.vanhove@example.com', regNumber: '12.10.22-086.86' },
        { name: 'Van Impe Marie', city: 'Moerkerke', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-01-14', phone: '470000087', email: 'marie.vanimpe@example.com', regNumber: '13.01.14-087.87' },
        { name: 'Van Landeghem Emma', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-07-08', phone: '470000088', email: 'emma.vanlandeghem@example.com', regNumber: '11.07.08-088.88' },
        { name: 'Van Lierde Lisa', city: 'Westkapelle', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-03-31', phone: '470000089', email: 'lisa.vanlierde@example.com', regNumber: '12.03.31-089.89' },
        { name: 'Van Loo Julie', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-11-25', phone: '470000090', email: 'julie.vanloo@example.com', regNumber: '13.11.25-090.90' },
        { name: 'Van Mechelen Charlotte', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-09-16', phone: '470000091', email: 'charlotte.vanmechelen@example.com', regNumber: '11.09.16-091.91' },
        { name: 'Van Mol Luna', city: 'Zeebrugge', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-12-07', phone: '470000092', email: 'luna.vanmol@example.com', regNumber: '12.12.07-092.92' },
        { name: 'Van Nuffel Nora', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-05-20', phone: '470000093', email: 'nora.vannuffel@example.com', regNumber: '13.05.20-093.93' },
        { name: 'Van Ouytsel Fien', city: 'Moerkerke', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-02-11', phone: '470000094', email: 'fien.vanouytsel@example.com', regNumber: '11.02.11-094.94' },
        { name: 'Van Pelt Lotte', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-08-04', phone: '470000095', email: 'lotte.vanpelt@example.com', regNumber: '12.08.04-095.95' },
        { name: 'Van Peteghem Yara', city: 'Westkapelle', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-06-29', phone: '470000096', email: 'yara.vanpeteghem@example.com', regNumber: '13.06.29-096.96' },
        { name: 'Van Poucke Nina', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-04-13', phone: '470000097', email: 'nina.vanpoucke@example.com', regNumber: '11.04.13-097.97' },
        { name: 'Van Reeth Amber', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-01-26', phone: '470000098', email: 'amber.vanreeth@example.com', regNumber: '12.01.26-098.98' },
        { name: 'Van Riel Lina', city: 'Zeebrugge', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-10-09', phone: '470000099', email: 'lina.vanriel@example.com', regNumber: '13.10.09-099.99' },
        { name: 'Van Rompaey Julie', city: 'Moerkerke', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-11-30', phone: '470000100', email: 'julie.vanrompaey@example.com', regNumber: '11.11.30-100.100' },
        { name: 'Van Roy Charlotte', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-07-17', phone: '470000101', email: 'charlotte.vanroy@example.com', regNumber: '12.07.17-101.101' },
        { name: 'Van Schooten Luna', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-02-28', phone: '470000102', email: 'luna.vanschooten@example.com', regNumber: '13.02.28-102.102' },
        { name: 'Van Steenbergen Nora', city: 'Westkapelle', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-06-05', phone: '470000103', email: 'nora.vansteenbergen@example.com', regNumber: '11.06.05-103.103' },
        { name: 'Van Steenwinkel Fien', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-09-12', phone: '470000104', email: 'fien.vansteenwinkel@example.com', regNumber: '12.09.12-104.104' },
        { name: 'Van Tichelen Lotte', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-04-03', phone: '470000105', email: 'lotte.vantichelen@example.com', regNumber: '13.04.03-105.105' },
        { name: 'Van Tongerlo Yara', city: 'Zeebrugge', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-08-21', phone: '470000106', email: 'yara.vantongerlo@example.com', regNumber: '11.08.21-106.106' },
        { name: 'Van Vliet Nina', city: 'Moerkerke', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-11-14', phone: '470000107', email: 'nina.vanvliet@example.com', regNumber: '12.11.14-107.107' },
        { name: 'Van Wassenhove Amber', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-01-07', phone: '470000108', email: 'amber.vanwassenhove@example.com', regNumber: '13.01.07-108.108' },
        { name: 'Van Wezel Lina', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-12-25', phone: '470000109', email: 'lina.vanwezel@example.com', regNumber: '11.12.25-109.109' },
        { name: 'Van Wichelen Julie', city: 'Westkapelle', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-05-18', phone: '470000110', email: 'julie.vanwichelen@example.com', regNumber: '12.05.18-110.110' },
        { name: 'Van Winkel Charlotte', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-07-11', phone: '470000111', email: 'charlotte.vanwinkel@example.com', regNumber: '13.07.11-111.111' },
        { name: 'Van Winkel Luna', city: 'Zeebrugge', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-03-19', phone: '470000112', email: 'luna.vanwinkel@example.com', regNumber: '11.03.19-112.112' },
        { name: 'Van Winkel Nora', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-10-05', phone: '470000113', email: 'nora.vanwinkel@example.com', regNumber: '12.10.05-113.113' },
        { name: 'Van Winkel Fien', city: 'Moerkerke', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-09-22', phone: '470000114', email: 'fien.vanwinkel@example.com', regNumber: '13.09.22-114.114' },
        { name: 'Van Winkel Lotte', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-01-08', phone: '470000115', email: 'lotte.vanwinkel@example.com', regNumber: '11.01.08-115.115' },
        { name: 'Van Winkel Yara', city: 'Westkapelle', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-06-30', phone: '470000116', email: 'yara.vanwinkel@example.com', regNumber: '12.06.30-116.116' },
        { name: 'Van Winkel Nina', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-12-15', phone: '470000117', email: 'nina.vanwinkel@example.com', regNumber: '13.12.15-117.117' },
        { name: 'Van Winkel Amber', city: 'Zeebrugge', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-05-27', phone: '470000118', email: 'amber.vanwinkel@example.com', regNumber: '11.05.27-118.118' },
        { name: 'Van Winkel Lina', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-02-09', phone: '470000119', email: 'lina.vanwinkel@example.com', regNumber: '12.02.09-119.119' },
        { name: 'Van Winkel Julie', city: 'Moerkerke', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-08-01', phone: '470000120', email: 'julie.vanwinkel@example.com', regNumber: '13.08.01-120.120' },
        { name: 'Van Winkel Charlotte', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-10-31', phone: '470000121', email: 'charlotte.vanwinkel@example.com', regNumber: '11.10.31-121.121' },
        { name: 'Van Winkel Luna', city: 'Westkapelle', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-04-16', phone: '470000122', email: 'luna.vanwinkel@example.com', regNumber: '12.04.16-122.122' },
        { name: 'Van Winkel Nora', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-11-08', phone: '470000123', email: 'nora.vanwinkel@example.com', regNumber: '13.11.08-123.123' },
        { name: 'Van Winkel Fien', city: 'Zeebrugge', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-07-04', phone: '470000124', email: 'fien.vanwinkel@example.com', regNumber: '11.07.04-124.124' },
        { name: 'Van Winkel Lotte', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-01-20', phone: '470000125', email: 'lotte.vanwinkel@example.com', regNumber: '12.01.20-125.125' },
        { name: 'Van Winkel Yara', city: 'Moerkerke', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-06-13', phone: '470000126', email: 'yara.vanwinkel@example.com', regNumber: '13.06.13-126.126' },
        { name: 'Van Winkel Nina', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2011-09-29', phone: '470000127', email: 'nina.vanwinkel@example.com', regNumber: '11.09.29-127.127' },
        { name: 'Van Winkel Amber', city: 'Westkapelle', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2012-03-11', phone: '470000128', email: 'amber.vanwinkel@example.com', regNumber: '12.03.11-128.128' },
        { name: 'Van Winkel Lina', city: 'Knokke-Heist', group: 'URBAN 1 - GEBOORTEJAREN 2013 & 2012 & 2011', birthDate: '2013-10-26', phone: '470000129', email: 'lina.vanwinkel@example.com', regNumber: '13.10.26-129.129' },
        ...
        { name: 'Urban Advanced 1', city: 'Knokke-Heist', group: 'URBAN 3 - 16+ Na selectie/proefles', birthDate: '2006-11-08', phone: '470000007', email: 'urbanadvanced1@example.com', regNumber: '06.11.08-007.07' },
        { name: 'Urban Advanced 2', city: 'Knokke-Heist', group: 'URBAN 3 - 16+ Na selectie/proefles', birthDate: '2005-07-14', phone: '470000008', email: 'urbanadvanced2@example.com', regNumber: '05.07.14-008.08' },
        
        // URBAN TEENS - GEBOORTEJAREN 2016 & 2015 & 2014 (37 estudiantes)
        { name: 'Urban Teen Group 1', city: 'Knokke-Heist', group: 'URBAN TEENS - GEBOORTEJAREN 2016 & 2015 & 2014', birthDate: '2016-04-18', phone: '470000009', email: 'urbanteengroup1@example.com', regNumber: '16.04.18-009.09' },
        { name: 'Urban Teen Group 2', city: 'Knokke-Heist', group: 'URBAN TEENS - GEBOORTEJAREN 2016 & 2015 & 2014', birthDate: '2015-10-22', phone: '470000010', email: 'urbanteengroup2@example.com', regNumber: '15.10.22-010.10' },
        { name: 'Urban Teen Group 3', city: 'Zeebrugge', group: 'URBAN TEENS - GEBOORTEJAREN 2016 & 2015 & 2014', birthDate: '2014-02-28', phone: '470000011', email: 'urbanteengroup3@example.com', regNumber: '14.02.28-011.11' },
        
        // MODERN TEENS - GEBOORTEJAREN 2016 & 2015 & 2014 (28 estudiantes)
        { name: 'Modern Teen 1', city: 'Knokke-Heist', group: 'MODERN TEENS - GEBOORTEJAREN 2016 & 2015 & 2014', birthDate: '2016-01-15', phone: '470000012', email: 'modernteen1@example.com', regNumber: '16.01.15-012.12' },
        ...
        { name: 'Van Assche Liam', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-12-08', phone: '470000133', email: 'liam.vanassche@example.com', regNumber: '06.12.08-133.133' },
        { name: 'Van Baelen Emma', city: 'Moerkerke', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-05-19', phone: '470000134', email: 'emma.vanbaelen@example.com', regNumber: '08.05.19-134.134' },
        { name: 'Van Belle Noah', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-01-25', phone: '470000135', email: 'noah.vanbelle@example.com', regNumber: '07.01.25-135.135' },
        { name: 'Van Biesen Olivia', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-06-12', phone: '470000136', email: 'olivia.vanbiesen@example.com', regNumber: '06.06.12-136.136' },
        { name: 'Van Damme Lucas', city: 'Westkapelle', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-09-03', phone: '470000137', email: 'lucas.vandamme@example.com', regNumber: '08.09.03-137.137' },
        { name: 'Van De Velde Ella', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-04-18', phone: '470000138', email: 'ella.vandevelde@example.com', regNumber: '07.04.18-138.138' },
        { name: 'Van Den Bossche Arthur', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-11-07', phone: '470000139', email: 'arthur.vandenbossche@example.com', regNumber: '06.11.07-139.139' },
        { name: 'Van Den Broeck Nora', city: 'Zeebrugge', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-02-14', phone: '470000140', email: 'nora.vandenbroeck@example.com', regNumber: '08.02.14-140.140' },
        { name: 'Van Der Aa Max', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-08-29', phone: '470000141', email: 'max.vanderaa@example.com', regNumber: '07.08.29-141.141' },
        { name: 'Van Der Beken Lisa', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-03-16', phone: '470000142', email: 'lisa.vanderbeken@example.com', regNumber: '06.03.16-142.142' },
        { name: 'Van Der Heyden Felix', city: 'Moerkerke', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-07-22', phone: '470000143', email: 'felix.vanderheyden@example.com', regNumber: '08.07.22-143.143' },
        { name: 'Van Der Straeten Nina', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-12-05', phone: '470000144', email: 'nina.vanderstraeten@example.com', regNumber: '07.12.05-144.144' },
        { name: 'Van Dijck Thomas', city: 'Moerkerke', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-10-18', phone: '470000145', email: 'thomas.vandijck@example.com', regNumber: '06.10.18-145.145' },
        { name: 'Van Eyck Emma', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-01-30', phone: '470000146', email: 'emma.vaneyck@example.com', regNumber: '08.01.30-146.146' },
        { name: 'Van Gompel Felix', city: 'Westkapelle', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-06-14', phone: '470000147', email: 'felix.vangompel@example.com', regNumber: '07.06.14-147.147' },
        { name: 'Van Hecke Nina', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-09-27', phone: '470000148', email: 'nina.vanhecke@example.com', regNumber: '06.09.27-148.148' },
        { name: 'Van Hoof Thomas', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-04-11', phone: '470000149', email: 'thomas.vanhoof@example.com', regNumber: '08.04.11-149.149' },
        { name: 'Van Hove Emma', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-11-23', phone: '470000150', email: 'emma.vanhove@example.com', regNumber: '07.11.23-150.150' },
        { name: 'Van Impe Felix', city: 'Moerkerke', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-05-09', phone: '470000151', email: 'felix.vanimpe@example.com', regNumber: '06.05.09-151.151' },
        { name: 'Van Landeghem Nina', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-08-16', phone: '470000152', email: 'nina.vanlandeghem@example.com', regNumber: '08.08.16-152.152' },
        { name: 'Van Lierde Thomas', city: 'Westkapelle', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-02-28', phone: '470000153', email: 'thomas.vanlierde@example.com', regNumber: '07.02.28-153.153' },
        { name: 'Van Loo Emma', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-12-19', phone: '470000154', email: 'emma.vanloo@example.com', regNumber: '06.12.19-154.154' },
        { name: 'Van Mechelen Felix', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-03-07', phone: '470000155', email: 'felix.vanmechelen@example.com', regNumber: '08.03.07-155.155' },
        { name: 'Van Mol Nina', city: 'Zeebrugge', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-07-31', phone: '470000156', email: 'nina.vanmol@example.com', regNumber: '07.07.31-156.156' },
        { name: 'Van Nuffel Thomas', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-01-14', phone: '470000157', email: 'thomas.vannuffel@example.com', regNumber: '06.01.14-157.157' },
        { name: 'Van Ouytsel Emma', city: 'Moerkerke', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-10-25', phone: '470000158', email: 'emma.vanouytsel@example.com', regNumber: '08.10.25-158.158' },
        { name: 'Van Pelt Felix', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-05-03', phone: '470000159', email: 'felix.vanpelt@example.com', regNumber: '07.05.03-159.159' },
        { name: 'Van Peteghem Nina', city: 'Westkapelle', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-08-20', phone: '470000160', email: 'nina.vanpeteghem@example.com', regNumber: '06.08.20-160.160' },
        { name: 'Van Poucke Thomas', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-12-01', phone: '470000161', email: 'thomas.vanpoucke@example.com', regNumber: '08.12.01-161.161' },
        { name: 'Van Reeth Emma', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-04-12', phone: '470000162', email: 'emma.vanreeth@example.com', regNumber: '07.04.12-162.162' },
        { name: 'Van Riel Felix', city: 'Zeebrugge', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-11-29', phone: '470000163', email: 'felix.vanriel@example.com', regNumber: '06.11.29-163.163' },
        { name: 'Van Rompaey Nina', city: 'Moerkerke', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-06-08', phone: '470000164', email: 'nina.vanrompaey@example.com', regNumber: '08.06.08-164.164' },
        { name: 'Van Roy Thomas', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-09-15', phone: '470000165', email: 'thomas.vanroy@example.com', regNumber: '07.09.15-165.165' },
        { name: 'Van Schooten Emma', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-02-28', phone: '470000166', email: 'emma.vanschooten@example.com', regNumber: '06.02.28-166.166' },
        { name: 'Van Steenbergen Felix', city: 'Westkapelle', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-07-19', phone: '470000167', email: 'felix.vansteenbergen@example.com', regNumber: '08.07.19-167.167' },
        { name: 'Van Steenwinkel Nina', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-01-06', phone: '470000168', email: 'nina.vansteenwinkel@example.com', regNumber: '07.01.06-168.168' },
        { name: 'Van Tichelen Thomas', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-10-13', phone: '470000169', email: 'thomas.vantichelen@example.com', regNumber: '06.10.13-169.169' },
        { name: 'Van Tongerlo Emma', city: 'Zeebrugge', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-05-02', phone: '470000170', email: 'emma.vantongerlo@example.com', regNumber: '08.05.02-170.170' },
        { name: 'Van Vliet Felix', city: 'Moerkerke', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-08-24', phone: '470000171', email: 'felix.vanvliet@example.com', regNumber: '07.08.24-171.171' },
        { name: 'Van Wassenhove Nina', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-03-31', phone: '470000172', email: 'nina.vanwassenhove@example.com', regNumber: '06.03.31-172.172' },
        { name: 'Van Wezel Thomas', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2008-11-17', phone: '470000173', email: 'thomas.vanwezel@example.com', regNumber: '08.11.17-173.173' },
        { name: 'Van Wichelen Emma', city: 'Westkapelle', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2007-06-09', phone: '470000174', email: 'emma.vanwichelen@example.com', regNumber: '07.06.09-174.174' },
        { name: 'Van Winkel Felix', city: 'Knokke-Heist', group: 'URBAN 2 - 14+ of na selectie/proefles', birthDate: '2006-12-22', phone: '470000175', email: 'felix.vanwinkel@example.com', regNumber: '06.12.22-175.175' },
        { name: 'Waeghe Lauren', city: 'Knokke-Heist', group: 'MINI\'S  - Geboortejaar 2021/2020', birthDate: '2021-10-19', phone: '472851462', email: 'katrien_vg@hotmail.com', regNumber: '21101903631' },
